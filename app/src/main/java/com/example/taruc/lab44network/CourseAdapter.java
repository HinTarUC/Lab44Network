...
public class CourseAdapter extends ArrayAdapter<Course> {
    ...
    public CourseAdapter(Activity context,
        ...
        //resources = the layout in the host activity
    ...
    public View getView(int position,
        ...
        //getContext = getting the current activity as it is not from project u running or the activity
